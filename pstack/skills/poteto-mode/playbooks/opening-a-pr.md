...
**Worktree.** Work from a git worktree off main; delegates receive its path or branch. Concurrent writers each get their own worktree. Dirty branch with unrelated work: patch out, fresh worktree, apply. Snarled worktree: reset from main, redo minimally.
