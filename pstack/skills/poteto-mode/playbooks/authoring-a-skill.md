...
1. Use an installed **create-skill** or equivalent skill-authoring capability. If none exists, edit the local `SKILL.md` directly and validate it against the Agent Skills specification.
