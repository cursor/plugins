...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and the active source-control host's PR list and diffs, upper-stack diffs, or PR context show it is used by a later PR in the stack.
