...
- `model`: your configured why-investigators model (a slug this session's spawn tool lists)
...
- `subagent_type`: generic slug from [`../poteto-mode/references/harness.md`](../poteto-mode/references/harness.md)
- `model`: your configured why-synthesizer model (a slug this session's spawn tool lists)
