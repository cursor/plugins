...
1. Spawn the comments agent from [`../poteto-mode/references/harness.md`](../poteto-mode/references/harness.md) (`comment-sicko` / `pstack:comment-sicko`). Pass the scope. Do not restate its rules. If spawn lookup fails, spawn poteto with `agents/comment-sicko.md` as the prompt.
