...
- `model`: the configured `interrogate reviewers` entry, or the table default with no configured line, if this session's spawn tool lists it
- `readonly`: `true`
