...
Copy this file outside the source pack, for example to `.codex/benny/routing.md`, and replace every placeholder. Point `routing.map_path` at the copy. Pack refreshes must not overwrite it.
