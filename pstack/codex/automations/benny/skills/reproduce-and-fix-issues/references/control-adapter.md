...
Set the completed user-facing feature map path in `control.feature_map_path`. Copy and fill [`feature-map.example.md`](./feature-map.example.md) outside the source pack, for example under `.codex/benny/`, instead of editing the copied example.
