...
Copy this file outside the source pack, for example to `.codex/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
