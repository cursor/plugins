...
3. Plan the fix from the trace. If it crosses a function boundary, `$pstack:architect` first. Delegate implementation to a Sol panel at `xhigh`; review the diff. Capture a post-fix trace.
