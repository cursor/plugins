...
A subagent that opens a PR runs `$pstack:interrogate`, `$deslop`, and `$pstack:no-comments` when available. It returns the URL and does not babysit. The parent accepts the result.
