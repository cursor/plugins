...
1. Identify the format and load it with the right tool. Parse large artifacts with a Luna panel at `xhigh` (the **principle-guard-the-context-window** skill) and keep the reduced finding in the main thread.
