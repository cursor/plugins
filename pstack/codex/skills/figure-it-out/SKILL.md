---
name: figure-it-out
description: Design and run an auditable playbook for a large migration, ambitious multi-part change, or other work that has no narrower workflow.
---
...
Use Codex's plan tool. Make the first item read the Principles section of the **poteto-mode** skill, then add the phases below.
