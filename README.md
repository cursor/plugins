...
| `usmail` | [USMail.ai](third_party/usmail/) | USMail.ai | Integrations | Prepare USMail.ai print-to-mail in Cursor. The agent uploads, configures, and generates a proof. A human funds the meter and approves production on the app. |
